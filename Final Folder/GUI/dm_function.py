...
def sorted_profit1(year,mon):
    ...
    while(count < 3): 
        ...
        print(data1)
    for i in data1['ProductName'].unique():
        d_product.append(i)
        d_MRP.append(data1[data1['ProductName']==i]['MRP per price'].sum())
        d_inventory.append(data1[data1['ProductName']==i]['Factory Price per piece'].sum())
        d_quantity.append(data1[data1['ProductName']==i]['Quantity'].sum())
        d_profit.append(data1[data1['ProductName']==i]['Profit per piece'].sum())
...
def sorted_profit(year,mon):
    ...
    for i in data['ProductName'].unique():
        d_product.append(i)
        d_MRP.append(data[data['ProductName']==i]['MRP per price'].sum())
        d_inventory.append(data[data['ProductName']==i]['Factory Price per piece'].sum())
        d_quantity.append(data[data['ProductName']==i]['Quantity'].sum())
        d_profit.append(data[data['ProductName']==i]['Profit per piece'].sum())
