...
target = Button(root, background = '#759EBD',text = "Targert Marketing", padx = 50, pady = 30, wraplength=80, command = targetmarketing)
...
personalized = Button(root, background = '#759EBD',text = "Personalized Experience", padx = 50, pady = 30, wraplength=80, command = personalised)
