...
pLabel = Label(root,text='Select Sub-Category : ', background='#7E85AB', fg = 'white')
pLabel.place(relx = 0.05, rely = 0.17)

proL = Label(root,text='Select Rating : ', background='#7E85AB', fg = 'white')
proL.place(relx = 0.05, rely = 0.295)

Label(root, text = 'Select Product : ', background='#7E85AB', fg = 'white').place(relx = 0.05, rely = 0.415)
...
catLabel = Label(root,text='Summary of selected product : ', background='#7E85AB', fg = 'white')
catLabel.place(relx = 0.62, rely = 0.55)   

Label(root, text = 'List of products : ', background='#7E85AB', fg = 'white').place(relx = 0.62, rely = 0.06)
